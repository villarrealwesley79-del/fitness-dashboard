...
def test_csrf_rollout_bumps_cached_asset_versions():
    ...
    assert "app-loader.js?v=20260605-fit236-active-draft" in index
    assert "app.js?v=20260605-fit236-active-draft" in Path("static/js/app-loader.js").read_text()
    assert "fitness-dashboard-v20260605-fit236-active-draft" in service_worker
