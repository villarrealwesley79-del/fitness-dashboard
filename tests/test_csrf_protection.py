...
def test_csrf_rollout_bumps_cached_asset_versions():
    ...
    assert "app-loader.js?v=20260713-fit233-adaptation-polling" in index
    assert "app.js?v=20260713-fit233-adaptation-polling" in Path("static/js/app-loader.js").read_text()
