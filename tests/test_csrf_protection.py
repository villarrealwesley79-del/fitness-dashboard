...
def test_csrf_rollout_bumps_cached_asset_versions():
    ...
    assert "app-loader.js?v=20260627-fit249-auto-mobile-invite" in index
    assert "app.js?v=20260627-fit249-auto-mobile-invite" in Path("static/js/app-loader.js").read_text()
