...
def test_active_workout_draft_restores_after_auth_scope_refresh_and_saves_on_background_events():
    ...
    assert "/static/js/app-loader.js?v=20260627-fit249-auto-mobile-invite" in APP_HTML
    assert "/static/js/app.js?v=20260627-fit249-auto-mobile-invite" in APP_LOADER_JS
    assert "const CACHE_NAME = 'fitness-dashboard-v20260627-fit249-auto-mobile-invite';" in APP_SW
