...
def test_app_bundle_and_service_worker_versions_were_bumped_for_rollout():
    ...
    sw = SW_JS.read_text()
    assert "/static/js/app-loader.js?v=20260625-fit237-load-defer" in html
    assert "/static/js/app.js?v=20260625-fit237-load-defer" in (ROOT / "static" / "js" / "app-loader.js").read_text()
