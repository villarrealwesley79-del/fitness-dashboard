...
| Estimate source tags | `ai_text_estimate`, `fallback_text_estimate`, `manual_review_estimate`, `barcode_pending_source`, `nutritionix`, `nutritionix_barcode`, `usda_fdc`, `usda_fdc_barcode`, `open_food_facts`, `open_food_facts_barcode`, `heb_curated_reference`, `local_cache`, `personal_vocab`, `stub_vision_estimate`, `vision_*`, composed sources such as `vision_*+nutritionix` | Estimate provenance. Provider internals in PRD 06; `stub_vision_estimate`/`vision_*` belong to PRD 05. |
