...
FIRST_SEEN_FILE="${APPLE_HEALTH_FIRST_SEEN_FILE:-${HOME}/fitness-dashboard/.apple-health-first-sync}"
STALE_AFTER_HOURS="${STALE_AFTER_HOURS:-36}"
DB_FILE="${APPLE_HEALTH_SYNC_DB:-${HOME}/fitness-dashboard/apple_health_sync.db}"
